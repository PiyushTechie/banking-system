        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <nav class="hidden md:flex space-x-8">
                    ...
                    <a href="#" class="text-blue-600 font-medium border-b-2 border-blue-600 pb-1">Transfer</a>
                    <a href="#" class="text-gray-700 hover:text-blue-600 font-medium">Accounts</a>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-6">
            <nav class="flex text-sm text-gray-600">
                ...
                <span class="text-gray-900 font-medium">Transfer Funds</span>
            </nav>
        </div>
        ...
        <div class="grid lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                <div class="transfer-container rounded-lg p-8">
                    
                    <!-- Page Title -->
                    <div class="mb-6">
                        <h1 class="text-3xl font-bold text-gray-900 mb-2">Transfer Funds</h1>
                        <p class="text-gray-600">Send money to another SecureBank account holder</p>
                    </div>
                    ...
                    <form action="TransferServlet" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-sm text-gray-500">
                                The recipient must have a SecureBank account
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-sm text-gray-500">
                                Minimum transfer: ₹0.01 | Maximum per transaction: ₹100,000
                            </p>
                        </div>
                        ...
                        <div class="flex gap-4 pt-4">
                            <button type="submit" 
                                    class="btn-primary flex-1 py-3 px-6 rounded-md text-white font-semibold">
                                Transfer Funds
                            </button>
                            <a href="index.jsp" 
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-yellow-800">
                                Please verify the recipient's email address before proceeding. Transfers cannot be reversed once completed.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white rounded-lg p-6 shadow-sm">
                    <h3 class="font-bold text-gray-900 mb-4">Transfer Guidelines</h3>
                    <div class="space-y-3 text-sm text-gray-700">
                        ...
                        <div class="flex items-start">
                            ...
                            <p>No transfer fees or charges</p>
                        </div>
                        <div class="flex items-start">
                            <svg class="w-5 h-5 text-blue-600 mr-2 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                ...
                <div class="bg-white rounded-lg p-6 shadow-sm">
                    <div class="flex items-center mb-3">
                        ...
                        <h3 class="font-bold text-gray-900">Secure Transfer</h3>
                    </div>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
                    ...
                    <p class="text-sm text-gray-700 mb-4">
                        Our customer support team is here to help you with your transfers.
                    </p>
